...
public class MailClient {
    ...
    public List<Email> getInbox() {
        ...
        POP3Client pop3 = new POP3Client(currentUser.getUsername(), currentUser.getSessionToken());
        return pop3.fetchInbox();
    }
    ...
    public Email readEmail(int emailId) {
        ...
        if (pop3.connect() && pop3.login()) {
            Email email = pop3.retrieveEmail(emailId);
            pop3.quit();
            return email;
        }
